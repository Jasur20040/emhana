<template>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Конструктор</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="/admin" class="d-block">Әкімшілік панелі</a>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            menu_items: [
                {
                    name: "Жасалған шақырулар",
                    font: "fa-list",
                    route_name: "admin.clientMaket.index",
                    menu_active: ["admin.clientMaket", "admin"],
                },
                {
                    name: "Макеттер",
                    font: "fa-list",
                    route_name: "admin.maket.index",
                    menu_active: ["admin.maket"],
                },
                {
                    name: "Шрифттар",
                    font: "fa-cogs",
                    route_name: "admin.shrift.index",
                    menu_active: ["admin.shrift"],
                },
                {
                    name: "Типтер",
                    font: "fa-list",
                    route_name: "admin.type.index",
                    menu_active: ["admin.type"],
                },
                {
                    name: "Профиль",
                    font: "fa-list",
