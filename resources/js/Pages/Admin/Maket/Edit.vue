<template>
    ...
    <head>
        <title>Админ панель | Макетті өңдеу</title>
                ...
                <div>
                    <div class="card-body">
                        ...
                        <div v-if="with_avatar">
                            <input type="file" @change="handleFileChange($event, 2)"
                                class="mb-2 form-control max_w-input">
                            <div class="form-group">
                            ...
                            <div class="max_w-input" v-if="isCropper">
                                ...
                                <button @click="cropImage" class="btn btn-success mb-3 mr-2"
                                    v-if="isCropper && input_ava">
                                    Суретті қырқу
                                </button>
                            ...
                            <div
                                class="ava_option_panel d-flex justify-content-around align-items-center w-fit-content">
                                ...
                                <input type="number" class="panel_input margin_width"
                                    v-model="avatar_sizes.margin_left">
                                ...
                                <input type="number" class="panel_input margin_width"
                                    v-model="avatar_sizes.border_radius">
                            </div>
                        </div>
                        <hr>
                        <div class="option_panel d-flex justify-content-around align-items-center" v-if="options.length"
                            ...
                            <input type="number" class="panel_input margin_width"
                                v-model="options[text_index].margin_top">
                            ...
                            <input type="number" class="panel_input margin_width"
                                v-model="options[text_index].transform_x">
                            ...
                            <input type="number" class="panel_input margin_width"
                                v-model="options[text_index].max_width">
                        ...
                        <div v-if="options.length">
                            ...
                            <div class="d-flex align-items-center" v-if="slider == 2">
                                ...
                                <b>Max font-size:</b>
                                <input type="number" class="panel_input margin_width"
                                    v-model="options[text_index].maxSize" :max="150" :min=20>
                            </div>
                            <div class="d-flex align-items-center" v-if="slider == 3">
                                ...
                                <input type="number" class="panel_input margin_width mr-2"
                                    v-model="options[text_index].line_height" :max="options[text_index].maxSize"
                                    :min=10>
                            </div>
                    ...
                    <div ref="parent" class="maket_container" :class="{ 'background_maket': bg_color }">
                        <div class="d-flex gap-1 h-100">
                            <div class="position-relative shablon">
                                <img ref="shablon_image" :src="'/storage/' + maket.shablon_image" class="maket_img"
                                    @load="adjustParentHeight" v-if="preview_shablon == null" />
                            ...
                            <div class="position-relative shablon" :class="{ 'background_maket': bg_color }">
                                <div class="ava_block" :style="avaStyles()">
                                    <img :src="'/storage/' + maket.ava_image" class="ava_imgg"
                                        v-if="cropped_ava == null"
                                ...
                                <img ref="image" :src="'/storage/' + maket.maket_image" class="maket_img"
                                    @load="adjustParentHeight" v-else />
                                <div class="texts d-block">
                                    <div v-for="(option, index) in options" :key="index">
                                        <div class="mx-auto text" contenteditable="true"
...
export default {
    ...
    data() {
        return {
            ...
            maket_image: null,
            preview_maket: null,
            selectedType: this.maket.type_id,
            title: this.maket.title,
            price: this.maket.price,
    ...
    methods: {
        getShrifts() {
            this.standartShrifts = this.maketShrifts.map(font => {
                return {
                    id: font.shrift.id,
                    name: font.shrift.name,
                };
            });
        },
        handleResize() {
        ...
        submit() {
            ...
            this.$inertia.post(
                route("admin.maket.update", this.maket.id),
                formData,
                {
